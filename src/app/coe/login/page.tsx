          ...
          <div className="flex flex-col justify-between rounded-[2rem] border border-cyan-400/15 bg-white/5 p-8 shadow-2xl shadow-cyan-950/20 backdrop-blur-2xl">
            <div className="space-y-6">
              ...
              <div className="grid gap-3 text-sm text-slate-300 sm:grid-cols-2">
                <div className="rounded-2xl border border-white/10 bg-black/20 p-4">COE-only login with signed backend sessions</div>
                <div className="rounded-2xl border border-white/10 bg-black/20 p-4">Evaluator and HOD profile administration</div>
                <div className="rounded-2xl border border-white/10 bg-black/20 p-4">Multi-subject, multi-department, multi-year support</div>
                <div className="rounded-2xl border border-white/10 bg-black/20 p-4">Integrated with AuraGrade backend and Supabase</div>
              </div>
            </div>
            <div className="mt-10 text-sm text-slate-400">
              Need the initial COE office account loaded? Use the Supabase SQL migration and add the first office member record.
            </div>
          </div>
